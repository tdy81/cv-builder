...
<div>
    ...
    <div class="border rounded-lg p-6 mb-6">
        <div class="mb-4">
            <label class="block text-sm text-black font-medium mb-1">Photo</label>
        ...
        <div class="mb-4">
            <label class="block text-sm text-black font-medium mb-1">Nom & Prénom</label>
        ...
        <div class="mb-4">
            <label class="block text-sm text-black font-medium mb-1">Métier</label>
        ...
        <div class="mb-4">
            <label class="block text-sm text-black font-medium mb-1">Adresse</label>
        ...
        <div class="flex gap-4">
            <div class="basis-1/2 mb-4">
                <label class="block text-sm text-black font-medium mb-1">Cp</label>
            ...
            <div class="basis-1/2 mb-4">
                <label class="block text-sm text-black font-medium mb-1">City</label>
        ...
        <div class="flex gap-4">
            ...
            <div class="basis-1/2 mb-4">
                <label class="block text-sm text-black font-medium mb-1">Phone</label>
